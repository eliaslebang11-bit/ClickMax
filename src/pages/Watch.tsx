...
import { Heart, Share2, MoreHorizontal, Bell, BellOff, Download, X, Clock, ListVideo, Check, MessageSquare, ChevronDown, Info, User, ArrowLeft } from "lucide-react";
...
export default function Watch() {
  ...
  const videoStat = id && stats[id] ? {
    views: Math.max(stats[id].views || 0, parseCount(video?.views || 0)),
    likes: Math.max(stats[id].likes || 0, parseCount(video?.likes || 0)),
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 py-1">
            ...
            <div className="flex items-center gap-3">
              ...
              <button 
                ...
                className={cn(
                  "flex items-center gap-2 px-4 py-2 rounded-full transition-colors border border-transparent",
                  isDownloaded 
