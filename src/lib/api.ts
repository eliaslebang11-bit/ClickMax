...
const getBaseUrl = () => {
  // If we are running in a web browser environment, default to relative paths to avoid
  // mixed-content (HTTPS page trying to hit HTTP localhost) or CORS/unreachable IP errors.
