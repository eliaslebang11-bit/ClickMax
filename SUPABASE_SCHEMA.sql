...
-- 11. Uploads Record Table (Metadata Storage for Cloudflare R2 Uploads)
...
CREATE POLICY "Public Uploads Access" ON public.uploads
    FOR SELECT USING (true);

CREATE POLICY "Manage Own Uploads" ON public.uploads
